  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center p-12">
      ...
      <div className="w-full text-right space-y-5 mt-20 mb-36 ">
        ...
        <button className="w-32 h-10 bg-gradient-to-r from-[#b6f492] to-[#338b93] font-bold text-lg text-uppercase text-gray-700 tracking-widest rounded-full active:translate-y-[1px]">
          Start
        </button>
      </div>
    </div>
